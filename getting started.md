...
1. ID Matrix
    ...
    Step 3. Take the ID matrix block 
...
1. log
    ...
    Step 5. The value will be printed in the Log area at the bottom of the screen above th terminal
1. Mult
...
1. Merge
    ...
    Step5. Take the images you get from above and join them to the merge block and the merged image will be displayed in the merge block
1. Rotate
